...
%Instructions are inserted before branches or at function level. 
%With microarchitectural features, some features can not be controlled directly {\em i.e., }

%idea microarchitectural attack evasion is only possible by changing methods, 
